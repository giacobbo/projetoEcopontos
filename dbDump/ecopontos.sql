...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2017 at 04:24 PM
...
--
-- Table structure for table `estab_has_tiporesiduo`
--

CREATE TABLE `estab_has_tiporesiduo` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `estab_has_tiporesiduo`
--

INSERT INTO `estab_has_tiporesiduo` (`id`, `estabelecimento`, `residuo`) VALUES
(6, 10, 1),
(7, 10, 2),
(8, 10, 3),
(17, 0, 1),
...
(1, 'Title', 'slug', 'orem ipsum dolor sit amet, consectetur adipiscing elit. In in lectus eu nisl tempor dapibus. Sed viverra nec mauris eu rutrum. Maecenas vestibulum, sapien ac eleifend blandit, justo eros sodales nisl, sit amet gravida nunc felis a risus. Donec aliquet est mi, at posuere tortor commodo at. Pellentesque laoreet ullamcorper luctus. Sed id placerat dolor. Proin convallis ultricies vulputate. Nam placerat lacus vitae dui pretium posuere. Nam ac blandit orci. Maecenas sed lorem eu nibh varius auctor. Phasellus ullamcorper pretium ante, non varius turpis tempor non. Phasellus pharetra varius est, eu euismod velit pharetra id.'),
(2, 'tituloum', 'tituloum', 'testo');
...
INSERT INTO `pontocoleta` (`id`, `nome`, `estado`, `cidade`, `rua`, `numero`, `complemento`, `cep`, `lat`, `lng`) VALUES
(1, 'ponto', 24, 7973, 'rua', 1, 'comp', 0, 0.000000, 0.000000),
(2, 'nome', 5, 323, 'rue', 123, 'comp', 123, 0.000000, 0.000000),
(3, '123', 1, 3, '', 0, '', 0, 0.000000, 0.000000),
(4, 'teste', 1, 6, 'rua', 123, 'comp', 321, 0.000000, 0.000000),
(10, 'Commiteditado', 23, 7494, 'ipiranga', 6681, 'comp', 321, -30.057217, -51.172295),
(12, 'testecoord', 24, 7973, 'Carlos Seara', 567, 'comp', 123654, -26.911245, -48.670986),
(14, 'Roque', 24, 7973, 'Sebastião Lucas Pereira', 468, '', 88303480, -26.913002, -48.681953);
...
INSERT INTO `tiporesiduo` (`id`, `nome`, `descricao`) VALUES
(1, 'Celular', ''),
(2, 'Computador', ''),
(3, 'Pilha', '');
...
INSERT INTO `usuario` (`id`, `nome`, `cpf`, `email`, `senha`, `tipo`, `status`) VALUES
(1, 'Victor', '123', 'taefox@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 1, 0),
(2, '123', '12332123123', 'victor123@gmail.com.br', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 0, 0),
(4, '123', '12332123123', 'victor123@gmail.com.br', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 0, 0),
(8, 'user', '31212312312312', 'giacobbo@me.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', NULL, 0),
(9, 'taefox', '123123', 'vggiacobbo@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', NULL, 0);
...
--
-- Indexes for table `estab_has_tiporesiduo`
--
ALTER TABLE `estab_has_tiporesiduo`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `pontocoleta`
--
ALTER TABLE `pontocoleta`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `estab_has_tiporesiduo`
--
ALTER TABLE `estab_has_tiporesiduo`
...
--
-- AUTO_INCREMENT for table `pontocoleta`
--
ALTER TABLE `pontocoleta`
